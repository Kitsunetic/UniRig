...
from ..tokenizer.spec import TokenizerConfig, TokenizerSpec
from .asset import Asset
from .datapath import Datapath, DatapathConfig
    ...
    def __init__(
        ...
        if self.validate_dataset_config is not None:
            self.validate_datapath = {
                cls: Datapath(self.validate_dataset_config[cls].datapath_config) for cls in self.validate_dataset_config
            }
        else:
        ...
        if datapath is not None:
            ...
            if self.predict_dataset_config is not None:
                self.predict_datapath = {
                    cls: Datapath(self.predict_dataset_config[cls].datapath_config) for cls in self.predict_dataset_config
                }
            else:
