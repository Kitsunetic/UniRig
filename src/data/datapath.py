                    ...
                    with open(path, "r") as f:
                        ...
                        for l in f.readlines():
                            ...
                            if not os.path.exists(raw_data_path):
                                ...
                                continue
                            file_items.append(
                                {"cls": cls, "path": os.path.join(self.config.input_dataset_dir, l.strip()), "prob": p}
                            )
