...
from .log import add_error, add_warning, end_log, new_entry, new_log
    ...
    if inputs is not None:  # specified input file(s)
        ...
        for file in inputs:
            ...
            if warning and output_dir in vis:
                print(
                    f"\033[33mWARNING: duplicate output directory: {output_dir}, you need to rename prefix of files to avoid ambiguity\033[0m"
                )
            vis[output_dir] = True
